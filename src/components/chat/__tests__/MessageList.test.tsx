...
test("MessageList renders without crash when messages array is empty", () => {
  const { container } = render(<MessageList messages={[]} />);
  // Empty-state copy lives in ChatInterface, not MessageList
  expect(container.querySelector(".flex.flex-col.h-full")).toBeDefined();
});
